...
- Reservation, booking, and payment endpoints are internal services and should be isolated from public traffic or protected with service-to-service authentication outside local development.
...
- Replace the example database password and inject secrets through the deployment platform; never commit them to Git.
